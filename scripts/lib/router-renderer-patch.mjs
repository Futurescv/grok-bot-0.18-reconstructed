...
const RRouterProviders=[
  ...
  {value:"anthropic",label:"Anthropic API",description:"Use an Anthropic API key directly, or any Anthropic-compatible endpoint.",kind:"key",secret:"GROKBOT_ANTHROPIC_API_KEY"}
